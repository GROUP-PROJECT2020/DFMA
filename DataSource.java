...
public class DataSource
{
  ...
  private static ArrayList<AlarmHelper> mList = null;
  ...
  private static void load()
  {
    ...
    mList = new ArrayList<AlarmHelper>();
    mNextId = 1;
    ...
    try
    {
      ...
      if (MAGIC_NUMBER == magic)
      {
        ...
        {
          AlarmHelper alarm = new AlarmHelper(mContext);
  ...
  public static AlarmHelper get(int position)
  {
    return mList.get(position);
  }

  public static void add(AlarmHelper alarm)
  {
    alarm.setId(mNextId++);
    mList.add(alarm);
  ...
  public static void update(AlarmHelper alarm)
  {
    alarm.update();
    Collections.sort(mList);
    save();
