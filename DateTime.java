...
public class DateTime
{
  ...
  public String formatTime(AlarmHelper alarm)
  {
    return mTimeFormat.format(new Date(alarm.getDate()));
  }

  public String formatDate(AlarmHelper alarm)
  {
    return mDateFormat.format(new Date(alarm.getDate()));
  }

  public String formatDays(AlarmHelper alarm)
  {
...
//    res += " (" + formatDate(alarm) + ")";
  ...
  public String formatDetails(AlarmHelper alarm)
  {
    String res = "???";

    if (alarm.getEvent() == AlarmHelper.ONCE)
      res = formatDate(alarm);
    else if (alarm.getEvent() == AlarmHelper.WEEKLY)
  ...
  public boolean[] getDays(AlarmHelper alarm)
  {
  ...
  public void setDays(AlarmHelper alarm, boolean[] days)
  {
    int offs = mWeekStartsOnMonday ? 0 : 1; 
    int sDays = 0;
